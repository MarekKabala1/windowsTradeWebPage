...
const DEFAULT_CARDS_ITEMS: CardItems[] = [
	...
	{
		header: 'Installation',
		content: 'If you are building a new home or office, we can install new windows and doors for you.',
	},
	{
		header: 'Orders',
		content: 'We can order new windows and doors for you. We can also order replacement parts for existing windows and doors.',
	},
];
		...
		<section className='cards-container'>
			<ul className='cards-content'>
				{items.map((item, index) => {
					return (
						<li className='card section fade-in-section' id={`card_${index + 1}`} key={index}>
